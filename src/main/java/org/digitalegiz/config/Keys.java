/*
 * Copyright 2019 - 2024 Anton Tananaev (anton@digitalegiz.org)
 *
...
public final class Keys {
    ...
    public static final ConfigKey<String> SERVER_STATISTICS = new StringConfigKey(
            "server.statistics",
            List.of(KeyType.CONFIG),
            "https://www.digitalegiz.org/analytics/");
...
>>>>>>> master
    ...
    /**
     * LDAP server URL. For more info check <a href="https://www.digitalegiz.org/ldap/">LDAP config</a>.
     */
...
>>>>>>> master
     ...
     * If this is not provided, DigitalEgiz will use name "groups" scope.
     */
